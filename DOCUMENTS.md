...
|RESEND_EMAIL_DOMAIN|technewity.com|Email Domain||
|AWS_ACCESS_KEY||AWS s3 access key||
|AWS_SECRET_ACCESS_KEY||AWS s3 secret key||
|AWS_REGION|ap-southeast-1|Aws region||
|AWS_S3_BUCKET|technewitystore|Aws bucket name||
...
NEXT_PUBLIC_LIVEKIT_URL|wss://livekit.technewity.com|Livekit url||

### Configure log server
|Name|Value|Desc|Required|
|-|-|-|-|
|AXIOM_DATASET|technewity|Axiom dataset name||
|AXIOM_TOKEN|technewity|Axiom token||

### Configure firebase for email verification
|Name|Value|Desc|Required|
|-|-|-|-|
|FIREBASE_PROJECT_ID|technewity-labs|Project id||
|FIREBASE_CLIENT_EMAIL|adminsdk-123sd@technewity.iam.gserviceaccount.com|Client email generated by Firebase||

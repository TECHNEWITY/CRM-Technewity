...
export default function CustomFieldMultiAction() {
  ...
  return <div style={{ height: 'calc(100dvh - 78px)', top: 78 }} className="fixed right-0 h-full w-[300px] z-40 bg-white dark:bg-gray-900 dark:border-gray-700 border-t border-l shadow-md">
